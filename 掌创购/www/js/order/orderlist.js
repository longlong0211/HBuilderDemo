...
var _currentuser, _statuslist = [], _takeaway;
function plusReady() {
...
function painttab() {
    ...
    if ([2, 3].indexOf(_currentuser.user_type) > -1) {
        ...
        html += '<div class="search-wrap"><span class="searchicon"><i class="search icon"></i></span><input type="text" id="searchtext" placeholder="请输入订单号或者手机号" class="search-text f-l"><input type="button" id="btnserach" value="搜索"  class="search-btn f-r"></div>';
        html += '<div id="store_order_cate" class="tab-wrap"><table><tbody><tr><th><a tip="" class="fc-org">全部</a></th><th><a tip="0|1|2">交易中</a></th><th><a tip="-2|-3">退款</a></th></tr></tbody></table></div>';
    }
    else {
        html += '<div id="person_order_cate" class="tab-wrap"><table><tbody><tr><th><a class="fc-org" tip="">全部</a></th><th><a tip="0">未付款</a></th><th><a tip="1">未消费</a></th><th><a tip="2">待评价</a></th><th><a tip="-2|-3">退款</a></th></tr></tbody></table></div>';
    }
    html += "</div>";
...
function drawpage(orderlist, paintstyle) {
    ...
    for (var i = 0; i < orderlist.length; i++) {
        ...
        var num=0;
        $.each(order.goods, function(i,thisgoods) {
        	num += thisgoods.quantity
        });
        ...
        html.push("<li class='tips-part t-c'><div class='off-right-block'>" + hiddendata + "<span class='off-org-btn'>" + statusdesc + "</span></div></li>");
        html.push("<li class='text-part'><p>订单号：" + order.order_sn + "</p><p>时间：" + order.created_at.substr(0, 16) + "</p>");
        html.push("<p><span>数量：<em class='fc-green'>" + num + "</em></span> <span>");
        html.push("总价：<em class='fc-org'>￥" + order.money  );
        if(1 == order.is_discount){ html.push("<em style='font-size: 0.7em;padding-left:2px;'>" + order.discount.discount + "折</em>"  ); }        
        html.push('</em></span></p>');
